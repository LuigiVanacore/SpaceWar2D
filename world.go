...
func NewWorld() *World {
	...
	entitySprite2 := historia.NewEntitySprite(historia.NewSprite(Assets.ResourceManager().GetTexture(Assets.Ship)))
	entitySprite2.SetPivotToCenter()
	entitySprite2.SetPosition(200, 200)
	sceneNode2 := historia.NewSceneNode(entitySprite2)
	sceneNode.AttachChild(sceneNode2)
	player := NewPlayer()
